...
CREATE TABLE IF NOT EXISTS shifts (
    ...
    per_patient_rate DECIMAL(10, 2) DEFAULT 0,
    estimated_patients INT DEFAULT 0,
    attended_patients INT DEFAULT 0,
    return_patients INT DEFAULT 0,
    deduct_lunch BOOLEAN DEFAULT FALSE,
    recurrence_group_id VARCHAR(100) DEFAULT NULL,
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
